...
class TurtleSpawner(Node):
    def __init__(self):
        ...
        self.declare_parameter("spawan_frequency", 1.0)
        self.declare_parameter("turtle_name_prefix", "turtle")
        
        self.spawan_frequency = self.get_parameter("spawan_frequency").value
        ...
        self.spawn_turtle_timer_ = self.create_timer(
            1.0 / self.spawan_frequency, self.spawn_new_turtle)
